...
$dbname = 'cse485_web'; // Tên CSDL bạn tạo
...
// TODO 2: Kiểm tra xem form đã gửi đi (method POST) và có 'ten_sinh_vien' không
if (isset($_POST['ten_sinh_vien'])) {
    ...
    // TODO 6: (Tùy chọn) Chuyển hướng và chỉnh trang này để "làm mới"
...
<body>
    ...
    <table>
        ...
        while ($row = $stmt_select->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<tr>";
            // htmlspecialchars là để bảo mật, tránh lỗi XSS
